                            ...
                            <div>
                                <Alert className="my-5">
                                    ...
                                    <AlertDescription className="text-gray-600">
                                        Login with the provided credentials to
                                        use the application.
                                    </AlertDescription>
                                </Alert>
                                <form className="space-y-4">
                                    ...
                                    <div className="flex gap-4 items-center justify-between py-7">
                                        <Button
                                            formAction={register}
                                            className="w-full bg-transparent outline outline-black outline-2 text-black hover:text-white"
                                        >
                                        ...
                                        <Button
                                            formAction={login}
                                            className="w-full outline outline-2 outline-black"
                                        >
